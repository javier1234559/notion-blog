...
import { IPostDetail ,ICategory } from "@/types/Blogtype";
...
const handler: Handler = async (event: HandlerEvent, context: HandlerContext) => {
    try {
        ...
        const slug: string | undefined = event.queryStringParameters?.slug; //.netlify/functions/getIFunction?slug=slug-1
        ...
        const pageData: IPostDetail = {
            ...
            category: response.properties.Category.multi_select as ICategory[] ?? [],
