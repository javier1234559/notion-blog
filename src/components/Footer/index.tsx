    ...
    return (
        <footer className='flex justify-between items-center'>
            ...
            <div className="grid grid-flow-row grid-cols-6 max-w-sm mx-auto">
                <a href="/" rel="noopener noreferrer nofollow" className="p-4" target="_blank" aria-label="github.com">
                ...
                <a href="https://www.linkedin.com/in/alan-john-b2b521193/" rel="noopener noreferrer nofollow" className="p-4" target="_blank" aria-label="www.linkedin.com">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" role="img" viewBox="0 0 24 24" className="text-2xl hover:text-accent-primary dark:hover:text-accent-secondary" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <title></title>
                ...
                <a href="https://dev.to/alanpjohn" rel="noopener noreferrer nofollow" className="p-4" target="_blank" aria-label="dev.to">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" role="img" viewBox="0 0 24 24" className="text-2xl hover:text-accent-primary dark:hover:text-accent-secondary" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <title></title>
                ...
                <a href="mailto:alansandra2013@gmail.com" rel="noopener noreferrer nofollow" className="p-4" target="_blank" aria-label="back">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" role="img" viewBox="0 0 24 24" className="text-2xl hover:text-accent-primary dark:hover:text-accent-secondary" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <title></title>
                ...
                <a href="https://twitter.com/alanpjohn" rel="noopener noreferrer nofollow" className="p-4" target="_blank" aria-label="twitter.com">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" role="img" viewBox="0 0 24 24" className="text-2xl hover:text-accent-primary dark:hover:text-accent-secondary" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <title></title>
